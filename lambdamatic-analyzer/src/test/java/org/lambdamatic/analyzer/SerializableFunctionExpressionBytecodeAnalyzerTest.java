	...
	public static Object[][] data() throws NoSuchMethodException, SecurityException {
		...
		return new Object[][] {
				new Object[] {
						...
						new MethodInvocation(new ClassLiteral(ArrayUtil.class), ArrayUtil_toArray, new ArrayVariable(Object[].class, new FieldAccess(testPojo, "stringValue"), new FieldAccess(testPojo, "dateValue")))
				},
				new Object[] {
						(SerializableFunction<TestPojo, Object[]>) ((TestPojo t) -> ArrayUtil.toArray(t.field)),
						new MethodInvocation(new ClassLiteral(ArrayUtil.class), ArrayUtil_toArray, new ArrayVariable(Object[].class, testPojo_dot_field)) },
				new Object[] {
						(SerializableFunction<TestPojo, Object[]>) ((TestPojo t) -> ArrayUtil.toArray(t.field,
								t.dateValue, t.elementList)),
						new MethodInvocation(new ClassLiteral(ArrayUtil.class), ArrayUtil_toArray, new ArrayVariable(Object[].class, testPojo_dot_field, testPojo_dot_dateValue, testPojo_dot_elementList )) 
						}
		};
	}
