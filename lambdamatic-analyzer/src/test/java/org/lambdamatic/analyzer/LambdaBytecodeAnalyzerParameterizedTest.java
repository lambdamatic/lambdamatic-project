	...
	public static Object[][] data() {
		...
		return new Object[][] {
				...
				new Object[] { (FilterExpression<TestPojo>) ((TestPojo t) -> t.getPrimitiveByteValue() > (byte)0),
						new InfixExpression(InfixOperator.GREATER, t_dot_getPrimitiveByteValue, new NumberLiteral(0)) },
				new Object[] { (FilterExpression<TestPojo>) ((TestPojo t) -> t.getPrimitiveByteValue() < byteValue_0),
						new InfixExpression(InfixOperator.LESS, t_dot_getPrimitiveByteValue, new NumberLiteral(0)) },
				new Object[] {
				...
				new Object[] { (FilterExpression<TestPojo>) ((TestPojo t) -> t.getByteValue() > (byte)0),
						new InfixExpression(InfixOperator.GREATER, t_dot_getByteValue, new NumberLiteral(0)) },
				new Object[] { (FilterExpression<TestPojo>) ((TestPojo t) -> t.getByteValue() < byteValue_0),
						new InfixExpression(InfixOperator.LESS, t_dot_getByteValue, new NumberLiteral(0)) },
				...
				new Object[] {
						...
						new InfixExpression(InfixOperator.LESS_EQUALS, t_dot_getByteValue, new NumberLiteral(
								intValue_1)) },
				...
				new Object[] {
						...
						new InfixExpression(InfixOperator.NOT_EQUALS, t_dot_getByteValue, new NumberLiteral(
								intValue_42)) },

				// primitive short  (comparing with NumberLiterals with int values - see bytecode instructions)
				new Object[] { (FilterExpression<TestPojo>) ((TestPojo t) -> t.getPrimitiveShortValue() > (short)0),
						new InfixExpression(InfixOperator.GREATER, t_dot_getPrimitiveShortValue, new NumberLiteral(0)) },
				new Object[] {
						(FilterExpression<TestPojo>) ((TestPojo t) -> t.getPrimitiveShortValue() < shortValue_0),
						new InfixExpression(InfixOperator.LESS, t_dot_getPrimitiveShortValue, new NumberLiteral(0)) },
				new Object[] {
				...
				// java.lang.Short (comparing with NumberLiterals with int values - see bytecode instructions)
				new Object[] { (FilterExpression<TestPojo>) ((TestPojo t) -> t.getShortValue() > (short)0),
						new InfixExpression(InfixOperator.GREATER, t_dot_getShortValue, new NumberLiteral(0)) },
				new Object[] { (FilterExpression<TestPojo>) ((TestPojo t) -> t.getShortValue() < shortValue_0),
						new InfixExpression(InfixOperator.LESS, t_dot_getShortValue, new NumberLiteral(0)) },
				...
				new Object[] {
						...
						new InfixExpression(InfixOperator.LESS, t_dot_getPrimitiveFloatValue, new NumberLiteral(0)) },
				new Object[] {
				...
				new Object[] {
						...
						new InfixExpression(InfixOperator.LESS_EQUALS, t_dot_getPrimitiveFloatValue, new NumberLiteral(
								floatValue_1)) },
				new Object[] { (FilterExpression<TestPojo>) ((TestPojo t) -> t.getPrimitiveFloatValue() == 42L),
						new InfixExpression(InfixOperator.EQUALS, t_dot_getPrimitiveFloatValue, new NumberLiteral(42L)) },
				new Object[] {
				...
				new Object[] { (FilterExpression<TestPojo>) ((TestPojo t) -> t.getFloatValue() < floatValue_0),
						new InfixExpression(InfixOperator.LESS, t_dot_getFloatValue, new NumberLiteral(0)) },
				...
				// primitive double
				new Object[] {
						(FilterExpression<TestPojo>) ((TestPojo t) -> t.getPrimitiveDoubleValue() > 0f),
						new InfixExpression(InfixOperator.GREATER, t_dot_getPrimitiveDoubleValue, new NumberLiteral(0f)) },
				new Object[] {
						(FilterExpression<TestPojo>) ((TestPojo t) -> t.getPrimitiveDoubleValue() < doubleValue_0),
						new InfixExpression(InfixOperator.LESS, t_dot_getPrimitiveDoubleValue, new NumberLiteral(0)) },
				new Object[] {
				...
				new Object[] {
						(FilterExpression<TestPojo>) ((TestPojo t) -> t.getPrimitiveDoubleValue() == 42L),
						new InfixExpression(InfixOperator.EQUALS, t_dot_getPrimitiveDoubleValue, new NumberLiteral(42L)) },
				new Object[] {
						...
						new InfixExpression(InfixOperator.NOT_EQUALS, t_dot_getPrimitiveDoubleValue, new NumberLiteral(
								doubleValue_42)) },
				// java.lang.Double
				new Object[] { (FilterExpression<TestPojo>) ((TestPojo t) -> t.getDoubleValue() > 0f),
						new InfixExpression(InfixOperator.GREATER, t_dot_getDoubleValue, new NumberLiteral(0f)) },
				new Object[] { (FilterExpression<TestPojo>) ((TestPojo t) -> t.getDoubleValue() < doubleValue_0),
						new InfixExpression(InfixOperator.LESS, t_dot_getDoubleValue, new NumberLiteral(0)) },
				new Object[] { (FilterExpression<TestPojo>) ((TestPojo t) -> t.getDoubleValue() >= 1f),
						new InfixExpression(InfixOperator.GREATER_EQUALS, t_dot_getDoubleValue, new NumberLiteral(1f)) },
				new Object[] {
						...
						new InfixExpression(InfixOperator.LESS_EQUALS, t_dot_getDoubleValue, new NumberLiteral(
								doubleValue_1)) },
				new Object[] { (FilterExpression<TestPojo>) ((TestPojo t) -> t.getDoubleValue() == 42f),
						new InfixExpression(InfixOperator.EQUALS, t_dot_getDoubleValue, new NumberLiteral(42f)) },
				new Object[] {
