...
public class SerializableFunctionBytecodeAnalyzeCacheTest {
	...
	public void shouldNotAnalyzeTwice() throws NoSuchMethodException, SecurityException {
		...
		final InfixExpression nestedExpression = new InfixExpression(InfixOperator.CONDITIONAL_OR, fieldEqualsJohnMethod, fieldEqualsJackMethod);
	...
	public void shouldNotAnalyzeTwiceWithCapturedArguments() throws NoSuchMethodException, SecurityException {
		...
		final InfixExpression nestedExpression1 = new InfixExpression(InfixOperator.CONDITIONAL_OR, fieldEqualsJohn1Method, fieldEqualsJack1Method);
		...
		final InfixExpression nestedExpression2 = new InfixExpression(InfixOperator.CONDITIONAL_OR, fieldEqualsJohn2Method, fieldEqualsJack2Method);
