...
public class ExpressionRewriterTest {
  ...
  public static Object[][] data() {
    ...
    final CompoundExpression getPrimitiveIntMethodEquals42_2 =
        new CompoundExpression(CompoundExpressionOperator.NOT_EQUALS,
            new MethodInvocation(var, TestPojo_getPrimitiveIntValue), new NumberLiteral(42));
    final CompoundExpression getPrimitiveIntMethodEquals42_3 =
        new CompoundExpression(CompoundExpressionOperator.NOT_EQUALS,
            new MethodInvocation(var, TestPojo_getPrimitiveIntValue), new NumberLiteral(42));
    ...
    final CompoundExpression expression1 = new CompoundExpression(
        CompoundExpressionOperator.CONDITIONAL_OR, getPrimitiveIntMethodEquals42_1,
        new CompoundExpression(CompoundExpressionOperator.CONDITIONAL_AND,
            getPrimitiveIntMethodEquals42_2, getEnumPojoMethodEqualsFieldBar_1),
        new CompoundExpression(CompoundExpressionOperator.CONDITIONAL_AND,
            getPrimitiveIntMethodEquals42_3, getEnumPojoMethodEqualsFieldBar_2.inverse(),
            getStringValueMethodEqualsFoo1));
    final CompoundExpression getEnumPojoMethodEqualsEnumBar_1 =
        new CompoundExpression(CompoundExpressionOperator.EQUALS,
            new MethodInvocation(var, TestPojo_getEnumPojo), new EnumLiteral(EnumPojo.BAR));
    final CompoundExpression getEnumPojoMethodEqualsEnumBar_2 =
        new CompoundExpression(CompoundExpressionOperator.EQUALS,
            new MethodInvocation(var, TestPojo_getEnumPojo), new EnumLiteral(EnumPojo.BAR));
    final CompoundExpression expectedExpression1 = new CompoundExpression(
        CompoundExpressionOperator.CONDITIONAL_OR, getPrimitiveIntMethodEquals42_1,
        new CompoundExpression(CompoundExpressionOperator.CONDITIONAL_AND,
            getPrimitiveIntMethodEquals42_2, getEnumPojoMethodEqualsEnumBar_1),
        new CompoundExpression(CompoundExpressionOperator.CONDITIONAL_AND,
            getPrimitiveIntMethodEquals42_3, getEnumPojoMethodEqualsEnumBar_2,
            getStringValueMethodEqualsFoo1));
    // Substitute 2 Enum literals from duplicate expressions
    final CompoundExpression getPrimitiveIntMethodEquals42 =
        new CompoundExpression(CompoundExpressionOperator.EQUALS,
            new MethodInvocation(var, TestPojo_getPrimitiveIntValue), new NumberLiteral(42));
    ...
    final CompoundExpression getStringValueMethodEqualsFoo =
        new CompoundExpression(CompoundExpressionOperator.EQUALS,
            new MethodInvocation(var, TestPojo_getStringValue), new StringLiteral("foo"));
    final CompoundExpression expression2 = new CompoundExpression(
        CompoundExpressionOperator.CONDITIONAL_OR, getPrimitiveIntMethodEquals42,
        new CompoundExpression(CompoundExpressionOperator.CONDITIONAL_AND,
            getPrimitiveIntMethodEquals42.inverse(), getEnumPojoMethodEqualsFieldBar),
        new CompoundExpression(CompoundExpressionOperator.CONDITIONAL_AND,
            getPrimitiveIntMethodEquals42.inverse(), getEnumPojoMethodEqualsFieldBar.inverse(),
            getStringValueMethodEqualsFoo));
    final CompoundExpression getEnumPojoMethodEqualsEnumBar =
        new CompoundExpression(CompoundExpressionOperator.EQUALS,
            new MethodInvocation(var, TestPojo_getEnumPojo), new EnumLiteral(EnumPojo.BAR));
    final CompoundExpression expectedExpression2 = new CompoundExpression(
        CompoundExpressionOperator.CONDITIONAL_OR, getPrimitiveIntMethodEquals42,
        new CompoundExpression(CompoundExpressionOperator.CONDITIONAL_AND,
            getPrimitiveIntMethodEquals42.inverse(), getEnumPojoMethodEqualsEnumBar),
        new CompoundExpression(CompoundExpressionOperator.CONDITIONAL_AND,
            getPrimitiveIntMethodEquals42.inverse(), getEnumPojoMethodEqualsEnumBar.inverse(),
            getStringValueMethodEqualsFoo));

    return new Object[][] {new Object[] {expression0, expression0},
        new Object[] {expression1, expectedExpression1},
        new Object[] {expression2, expectedExpression2},};
  }
