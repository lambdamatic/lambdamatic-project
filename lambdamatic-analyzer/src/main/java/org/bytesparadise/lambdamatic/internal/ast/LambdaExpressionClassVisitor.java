...
class LambdaExpressionClassVisitor extends ClassVisitor {
	...
	public MethodVisitor visitMethod(final int access, final String methodName, final String desc, final String signature, final String[] exceptions) {
		...
		if (methodName.equals(this.lambdaImplMethodName) && desc.equals(this.lambdaImplMethodSignature)) {
			LOGGER.debug("** Visiting {}.{} ({}) **", lambdaImplClassName, methodName, desc);
	...
	static class DesugaredLambdaExpressionMethodVisitor extends MethodVisitor {
		...
		public void visitAttribute(Attribute attr) {
			LOGGER.debug("Attribute {} (ignored)", attr);
		}

		@Override
		public void visitInsn(int opcode) {
			LOGGER.debug("Insn {}", Printer.OPCODES[opcode]);
			addInstruction(new InsnNode(opcode));
		}

		@Override
		public void visitIntInsn(int opcode, int operand) {
			LOGGER.debug("IntInsn {} {}", Printer.OPCODES[opcode], operand);
			addInstruction(new IntInsnNode(opcode, operand));
		}

		@Override
		public void visitVarInsn(int opcode, int var) {
			LOGGER.debug("VarInsn {} #{}", Printer.OPCODES[opcode], var);
			addInstruction(new VarInsnNode(opcode, var));
		}

		@Override
		public void visitTypeInsn(int opcode, String type) {
			LOGGER.debug("TypeInsn {} {}", Printer.OPCODES[opcode], type);
			addInstruction(new TypeInsnNode(opcode, type));
		}

		@Override
		public void visitMethodInsn(int opcode, String owner, String name, String desc) {
			LOGGER.debug("MethodInsn {} {}.{} (desc={})", Printer.OPCODES[opcode], owner, name, desc);
		...
		public void visitLdcInsn(Object cst) {
			LOGGER.debug("LdcInsn {}", cst);
			addInstruction(new LdcInsnNode(cst));
		}

		@Override
		public void visitFieldInsn(int opcode, String owner, String name, String desc) {
			LOGGER.debug("FieldInsn {} {}.{} (desc={}) (ignored)", Printer.OPCODES[opcode], owner, name, desc);
		}

		@Override
		public void visitIincInsn(int var, int increment) {
			LOGGER.debug("IincInsn #{} {} (ignored)", var, increment);
		}

		@Override
		public void visitJumpInsn(int opcode, Label label) {
			LOGGER.debug("JumpInsn {} {}", Printer.OPCODES[opcode], label.toString());
		...
		public void visitParameter(String name, int access) {
			LOGGER.debug("Parameter {} (ignored)", name);
		}

		@Override
		public void visitLocalVariable(String name, String desc, String signature, Label start, Label end, int index) {
			LOGGER.debug("LocalVariable {} (desc={}) index={}", name, desc, index);
