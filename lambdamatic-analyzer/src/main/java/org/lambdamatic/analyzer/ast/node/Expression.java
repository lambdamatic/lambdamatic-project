...
public abstract class Expression extends ASTNode implements Comparable<Expression> {
	...
	public enum ExpressionType {
		BOOLEAN_LITERAL, CHARACTER_LITERAL, CLASS_LITERAL, NUMBER_LITERAL, NULL_LITERAL, STRING_LITERAL, OBJECT_INSTANTIATION, METHOD_INVOCATION, FIELD_ACCESS, INFIX, INSTANCE_OF, LOCAL_VARIABLE, CAPTURED_ARGUMENT, ENUM_LITERAL;
	}
