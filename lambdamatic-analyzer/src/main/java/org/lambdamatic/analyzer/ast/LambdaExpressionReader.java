...
public class LambdaExpressionReader {
    ...
    while (insnCursor.hasCurrent()) {
      ...
      switch (currentInstruction.getType()) {
          ...
          switch (currentInstruction.getOpcode()) {
            ...
            case Opcodes.ILOAD:
              ...
              if (varInstruction.var < capturedArguments.size()) {
                ...
                final Object capturedArgumentValue =
                    capturedArguments.get(varInstruction.var).getValue();
                ...
                expressionStack
                    .add(new LocalVariable(var.index, var.name, readSignature(var.desc)));
              }
              break;
            case Opcodes.ASTORE:
          ...
          switch (methodInsnNode.getOpcode()) {
            ...
            case Opcodes.INVOKESPECIAL:
              ...
              if (methodInsnNode.name.equals("<init>")) {
                final ObjectInstanciation objectVariable =
                    (ObjectInstanciation) expressionStack.pop();
            ...
            case Opcodes.INVOKESTATIC:
              ...
              try {
                ...
                final Method javaMethod = ReflectionUtils.findJavaMethod(sourceClass,
        ...
        case AbstractInsnNode.INVOKE_DYNAMIC_INSN:
          ...
          final EmbeddedSerializedLambdaInfo lambdaInfo = new EmbeddedSerializedLambdaInfo(
        ...
        case AbstractInsnNode.INSN:
          final List<Statement> instructionStatement =
              readInstruction(insnCursor, expressionStack, capturedArguments, localVariables);
    ...
    switch (value.getExpressionType()) {
      ...
      default:
        throw new IllegalArgumentException("Could not convert '" + value + "' ("
            + value.getExpressionType() + ") into a Boolean Literal");
    }
  }
  ...
  private static Expression getControlFlowExpression(final JumpInsnNode jumpInsnNode,
    ...
    final Expression leftSideOperand = (expressionStack.empty()
        ? getDefaultComparisonOperand(rightSideOperand) : expressionStack.pop());
  ...
  private static Expression getDefaultComparisonOperand(final Expression expression) {
    ...
    throw new AnalyzeException(
        "Sorry, I can't give a default comparison operand for '" + expression + "'");
  }
    ...
    switch (typeInsnNode.getOpcode()) {
      ...
      case Opcodes.ANEWARRAY:
        ...
        final ArrayVariable arrayVariable =
            new ArrayVariable(getArrayType(parameterType), arrayLength.getValue().intValue());
