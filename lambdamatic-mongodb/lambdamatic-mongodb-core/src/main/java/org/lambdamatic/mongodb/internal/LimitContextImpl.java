 ...
 *
 */
class LimitContextImpl<DomainType>
    implements LimitContext<DomainType> {
  ...
  /**
   * @return the {@link FindIterable} for this context, eventually (lately) initializing it if it
