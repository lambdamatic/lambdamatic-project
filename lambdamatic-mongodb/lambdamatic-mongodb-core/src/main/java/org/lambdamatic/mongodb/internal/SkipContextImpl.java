...
/**
 * Context to specify the maximum number of Documents to retrieve or if only the first elment should be retrieved.
 * 
 * @author Xavier Coulon <xcoulon@redhat.com>
 *
 */
class SkipContextImpl<DomainType> extends LimitContextImpl<DomainType> implements SkipContext<DomainType>{
	 ...
	 */
	SkipContextImpl(final MongoCollection<DomainType> mongoCollection, final FilterExpression<DomainType> filterExpression) {
	 ...
	 */
	SkipContextImpl(final MongoCollection<DomainType> mongoCollection, final BsonDocument filterDocument) {
