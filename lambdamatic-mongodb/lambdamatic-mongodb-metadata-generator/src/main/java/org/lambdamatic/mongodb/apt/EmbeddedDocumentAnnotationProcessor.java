...
/**
 * Processor for classes annotated with {@code EmbeddedDocument}. Generates their associated {@link QueryMetadata},
 * {@link ProjectionMetadata} and {@link UpdateMetadata} implementation classes in the target folder given in the
 * constructor.
 * 
...
@SupportedAnnotationTypes({
		"org.lambdamatic.mongodb.annotations.EmbeddedDocument" })
...
public class EmbeddedDocumentAnnotationProcessor extends BaseAnnotationProcessor {
	...
	/**
	 * Generates the {@code QueryMetadata}, {@link ProjectionMetadata} and {@link UpdateMetadata} implementation sources
	 * for the annotated class currently being processed.
	 * 
