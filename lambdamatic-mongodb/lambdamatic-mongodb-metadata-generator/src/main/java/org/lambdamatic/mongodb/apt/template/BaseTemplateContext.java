...
public abstract class BaseTemplateContext {
	 ...
	 */
	public static final Function<TypeMirror, String> elementToPackageName = type -> ClassUtils
			.getPackageCanonicalName(type.toString());
	 ...
	 */
	public BaseTemplateContext(final DeclaredType domainType, final BaseAnnotationProcessor annotationProcessor) {
		this.domainType = domainType;
		this.annotationProcessor = annotationProcessor;
	}

	public String getPackageName() {
		return elementToPackageName.apply(domainType);
	}
	...
	public String getDomainClassName() {
		return domainType.asElement().getSimpleName().toString();
	}
	...
	public String getProcessorClassName() {
		return annotationProcessor.getClass().getName();
	}
